...
description: "Trust can be quantifed"
date: "25/12/2025"
---
...
![](/Users/gozzy/Desktop/The-Kula-Ring.webp)
...
T =  S t
$$
Yet trust is more nuanced than simple accumulation. The impact of any new interaction scales with both the current level of trust and the duration of the relationship - the greater the relationship's history and accumulated trust, the more drastic the effect. This is why we need a second equation for the projected impact on one's trust, which we call projected trust ($ΔT$), proportional to magnitude, existing trust, and time: 
$$
\Delta T = S_{new} \cdot T_{current} \cdot t \tag{2}
$$
...
TODO: Talk about Penrose first and the EU veto flaws

While governance theory has not evolved much past its early formalisation, there has been progress in preferential weighting when it comes voting, Quadratic Voting (QV), introduced by Weyl and Posner in 2017, uses a square-root method for voting weight—a principle with historical precedent in Penrose's square root law (1946) for proportional representation.  It's new found application for highlighting the voting minority was extraordinary when chreographed correctly. Its only flaw is the need for sybil protection because it ultimately fails from the exponential advantage to what is called as a "splitting attack". Much is the reason to why it has failed to be integral to capital markets and has shown more function in democratic settings, even Taiwan's digital minstry has ran pilots for budget ballots in 2018 further validating its benefits.
