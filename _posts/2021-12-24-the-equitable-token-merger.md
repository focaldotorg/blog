...
Protocols architected poorly set a bad precedent and standards for the industry, they are paradoxical to the true means of distributed systems and attempt to cash in on the value provided from so. Individual sovereignty is not only compromised but non-existant. These systems should not be designed in the faith of prolific actors, they should be equitable and diverse, or else they are just reflections of the inequitable societal structures we all know too well.
